...
// Configure CLUSTER if arg --cluster is passed
if (args.cluster === true && cluster.isMaster) {
  console.log(`El proceso master ${process.pid} está corriendo.`);
  ...
  cluster.on("exit", (worker, code, signal) => {
    console.log(`Worker ${worker.process.pid} termiado.`);
  });
} else {
  ...
  app.get("/info", (req, res) => {
    ...
    console.log(`Recibido en ${process.pid}`);
